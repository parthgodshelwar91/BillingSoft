...
{
    public class Temp_TradingAccountModel
    {
        [Display(Name = "Sr No")]
        ...
        public List<Temp_TradingAccountModel> Temp_TradingAccount_CreditList { get; set; }
        public List<Temp_TradingAccountModel> Temp_TradingAccount_DebitList { get; set; }
