...
{
    public class Temp_ProfitAndLossModel
    {
        [Display(Name = "Sr No")]
        ...
        public List<Temp_ProfitAndLossModel> Temp_ProfitAndLoss_CreditList { get; set; }
        public List<Temp_ProfitAndLossModel> Temp_ProfitAndLoss_DebitList { get; set; }
    }
}