...
{
    public class ClsTempProfitAndLoss
    {
        private string _connString;
        string SqlQry;

        public ClsTempProfitAndLoss()
        {
            _connString = WebConfigurationManager.ConnectionStrings["probillcon"].ToString();
        }

        public List<Temp_ProfitAndLossModel> ProfitAndLoss(string lsFilter)
        {
            ...
            SqlQry = SqlQry + "FROM temp_ProfitAndLoss ";
            ...
            List<Temp_ProfitAndLossModel> ProfitAndLoss = new List<Temp_ProfitAndLossModel>();
            foreach (DataRow row in dt.Rows)
            {
                Temp_ProfitAndLossModel tRow = new Temp_ProfitAndLossModel();
                ...
                ProfitAndLoss.Add(tRow);
            }
            return ProfitAndLoss;
        }

        //***** AccountsCrDr Register *********************************************
        public int spProfitAndLoss(string fin_year)
        {
            SqlConnection con = new SqlConnection(_connString);
            SqlCommand cmd = new SqlCommand("sp_ProfitAndLoss", con);
